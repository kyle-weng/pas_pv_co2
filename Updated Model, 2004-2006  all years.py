...
pyplot.figure(figsize=(19.2,10.8),dpi=100)
...
plotyear(2005)
plotyear(2006)
pyplot.legend(handles=[patches.Patch(color='red',label='2004'),patches.Patch(color='green',label='2005'),patches.Patch(color='blue',label='2006')])
pyplot.xlabel("OCS concentration (ppt)",fontsize=40)
pyplot.ylabel("Altitude (m)",fontsize=40)
pyplot.title("OCS Model, 2004-2006",fontsize=40)
axes = pyplot.gca()
axes.set_xlim([0,600])
